# Qolty HIPAA Compliance Policies

HIPAA compliance is complicated, but it doesn't have to be. Qolty helps relieve the technical burden with our HIPAA-compliant cloud computing platform and solutions for healthcare.
...
2. When ready, download the policies and comb through for mentions of Qolty or our business and change to appropriate references to your company.
3. Publish your policies in a publicly available location. The files are markdown, so you may need to convert to HTML if you don't have a publishing platform capable of markdown format. You can either create an index page linking to each individual policy, or create a single page listing all the policies in line, [much like we did](https://policy.Qolty.com).

## Who is behind this?

[Qolty](htts://Qolty.com), healthcare's trusted HITRUST CSF Certified digital health platform.

We help companies who handle PHI, both business associates and covered entities, maintain compliance with our ([Compliant Cloud](https://Qolty.com/compliant-cloud)) and ([Managed Integration](https://Qolty.com)).

To get in touch, shoot us an email at [hello@Qolty.com](mailto:hello@Qolty.com). We'd love to hear from you!
...
* [Qolty HIPAA Business Associate Agreement (“BAA”)](source/sections/23-Qolty_hipaa_business_associate_agreement.md)
* [HIPAA Mappings to Qolty Controls](source/sections/24-hipaa_mapping_to_Qolty_controls.md)
